...
export const DumbbellIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.95 14.95 0 00-5.84-2.56m0 0a14.95 14.95 0 01-5.84 2.56m5.84-2.56v-4.82a6 6 0 015.84-7.38v4.82" />
  </svg>
);

export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.69c.045.167.086.335.125.502m-11.964 4.69a21.035 21.035 0 015.63-1.256m0 0c1.153 0 2.243.15 3.261.426M5.12 14.25c-2.331 0-4.512.645-6.374 1.766l-.001.109a6.375 6.375 0 0111.964 4.69c-.045-.167-.086-.335-.125-.502m-11.964-4.69a21.035 21.035 0 015.63 1.256m0 0c-1.153 0-2.243-.15-3.261-.426m0 0c-2.331 0-4.512.645-6.374 1.766l-.001.109a6.375 6.375 0 0111.964 4.69c-.045-.167-.086-.335-.125-.502m-11.964-4.69a21.035 21.035 0 015.63 1.256m0 0c1.153 0 2.243.15 3.261.426" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.04 9.04 0 008.624-6.969c.253-.306.495-.623.722-.952 2.529-3.414 1.282-8.283-2.493-10.814A14.95 14.95 0 0012 2.25c-2.733 0-5.26.666-7.468 1.808A14.95 14.95 0 004.5 9.75c-3.775 2.53-5.022 7.4-2.493 10.814.227.329.469.646.722.952A9.04 9.04 0 0012 21z" />
  </svg>
);
...
export const FireIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.362-3.797A8.33 8.33 0 0112 2.25c1.153 0 2.243.3 3.224.834 1.135.636 2.09 1.566 2.67 2.67z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75v-.008a.75.75 0 01.75-.75z" />
  </svg>
);

export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.372c-1.034.103-1.933-.51-2.485-1.345l-2.022-2.899a.75.75 0 00-1.214 0l-2.022 2.899c-.552.835-1.451 1.448-2.485 1.345l-3.722-.372C3.847 17.1 3 16.136 3 15v-4.286c0-.97.616-1.813 1.5-2.097" />
  </svg>
);
